...
Revision ID: 52ad1cb4c0be
Revises: 043da5985f91
Create Date: 2025-09-23 15:35:56.149379
...
def upgrade() -> None:
    ...
    hame_plan_matter_trg_plan_matter_modified_at = PGTrigger(
        ...
        is_constraint=False,
        definition="BEFORE INSERT OR UPDATE ON plan_matter\n        FOR EACH ROW\n        EXECUTE FUNCTION hame.trgfunc_modified_at()",
    )
    ...
    op.alter_column(
        "source_data",
        "plan_id",
        new_column_name='plan_matter_id',
        schema="hame",
    )
