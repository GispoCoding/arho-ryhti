...
def test_database_creation(
    main_db_params_with_root_user: ConnectionParameters, hame_database_created
) -> None:
...
def test_database_all_migrations(
    main_db_params_with_root_user: ConnectionParameters, hame_database_migrated
) -> None:
    conn = psycopg.connect(**main_db_params_with_root_user)
    try:
        with conn.cursor() as cur:
...
def test_database_migrations_up_to_date(autogenerated_migration: Path | None) -> None:
    assert not autogenerated_migration


def test_database_cancel_all_migrations(
    main_db_params_with_root_user: ConnectionParameters,
    hame_database_migrated_down: str,
) -> None:
    conn = psycopg.connect(**main_db_params_with_root_user)
    try:
        with conn.cursor() as cur:
...
def test_database_upgrade(
    main_db_params_with_root_user: ConnectionParameters, hame_database_upgraded
) -> None:
    conn = psycopg.connect(**main_db_params_with_root_user)
    try:
        with conn.cursor() as cur:
...
def test_database_downgrade(
    main_db_params_with_root_user: ConnectionParameters, hame_database_downgraded
) -> None:
    conn = psycopg.connect(**main_db_params_with_root_user)
    try:
        with conn.cursor() as cur:
